...
<script type="text/javascript">
    ...
    initCallBackMA['<%=request("sIdsMaAndObj")%>'] = function (aCB, aDD) {
        ...
        debugger
        window.parent.Initialise_Popup("txFormula_simple", "temp_resources/models/TxFormula/WEB/TxFormulas_Popup.asp?Param1=" + JSON.stringify(jMAInput), 'Formula generator', 400, 300, '/temp_resources/models/TxFormulas/formulas.png', false, true, false, true);
