...
<script type="text/javascript">
    ...
    initCallBackMA['<%=request("sIdsMaAndObj")%>'] = function (aCB, aDD) {
        ...
        window.parent.Initialise_Popup("txFormula_simple", "temp_resources/models/TxFormula/WEB/TxFormulas_Popup.asp?Param1=" + JSON.stringify(jMAInput), 'Formula generator', 600, 400, '/temp_resources/models/TxFormula/web/iconFormulaForm.png', false, true, false, true);
