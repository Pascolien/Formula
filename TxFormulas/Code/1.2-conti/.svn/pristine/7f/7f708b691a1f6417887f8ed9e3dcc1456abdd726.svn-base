...
//#}	
	...
	*/
	this.createWindow = function(id, x, y, width, height) {
		...
		win.icons = new Array(this.imagePath+/*this.pathPrefix+this.skin= [BASSETTI]*/"/active/icon_normal.gif", this.imagePath+/*this.pathPrefix +this.skin+ [BASSETTI]*/"/inactive/icon_normal.gif");
		//
		win._allowMove = true;
...
//#}
	...
	this._clearDocumentEvents = function () {
		if (_isIE) _isIE = 11; // BASSETTI
		if (_isIE == 8) { //BASSETTI Modif _isIE --> _isIE == 8
