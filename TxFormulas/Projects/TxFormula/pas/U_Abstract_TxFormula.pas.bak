...
///<summary>Unit loading / unloading the dll named "TxFormula". This file is generated by TXUtils. Do not modify.</summary>
unit U_Abstract_TxFormula;
interface
...
///<summary>Procedure loading the dll named "TxFormula".</summary>
///<param name="AFilePath">The absolute path to the dll.</param>
procedure Load_TxFormula(AFilePath: string);

///<summary>Procedure unloading the dll named "TxFormula".</summary>
procedure Unload_TxFormula;

///<summary>Function returning true if the dll "TxFormula" was loaded.</summary>
function Get_Dll_TxFormula_Loaded: boolean;
