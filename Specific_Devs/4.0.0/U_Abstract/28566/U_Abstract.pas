...
type
  ...
  TPath=class(TObject)
  public
    ///<summary>Getter for the variable "Arr_ID".</summary>
    ///<summary>The list of objects identifiers sorted from the root to the leaf.</summary>
    function Get_Arr_ID: PArr_Integer; virtual; stdcall; abstract;
    function Get_Index(const AID_Object: Integer): Integer; virtual; stdcall; abstract;
    function Check_Kinship(const AID_Object: Integer; const AID_SupposedParent: Integer; out AIsChildOf: TAdvanced_Boolean): Boolean; virtual; stdcall; abstract;
  end;

  TCreate_OL_Path=function(const ASL_ID_Object: TStringList): TObjectList; stdcall;

  ///<summary>function creating a TPath object for a given object.</summary>
  ///<param name="AID_Object">the identifier of the Object.</param>
  TCreate_Path=function(const AID_Object: Integer): TPath; stdcall;

  TCreate_Path_From_IDs=function(const AIDs: string): TPath; stdcall;
  {$ENDREGION}
  ...
  ///<param name="AAdd_Parents">If true, parents objects are added to the list (even if not present in the list sent as parameter). The parents objects added are of the same class as their children objects (TD_Object_Data for example).</param>
  ///<returns>The objects returned are copies of the objects sent as parameter.</returns>
  TCreate_OL_Object_Tree_Sorted=function(AOlObject: TObjectList; AAdd_Parents: Boolean=False): TObjectList; stdcall;
  ...
  TCreate_OL_Object_From_Preselection=function(const ASlIdObject: TStringList; const ASortType: TObject_Ordering_Type=ootOrder_Ascending; const ADataType: Integer=-3): TObjectList; stdcall;
  ...
  ///<param name="ADataType">The class of the objects to create.</param>
  ///<returns>The result list contains TS_Object objects (or derivated objects).</returns>
  TCreate_OL_Object_From_Table=function(const ATable: string; const AIncludeFolders: Boolean=False; const ASortType: TObject_Ordering_Type=ootOrder_Ascending; const ADataType: Integer=-3): TObjectList; stdcall;
  ...
  public
    ...
    procedure Set_Value(const AValue: Boolean); virtual; stdcall; abstract;
  ...
  public
    ...
    procedure Select_From_Series_Type(const AWhat: array of Integer; const AWhere: array of string; var AResult: TStrings; const AClear_Result: Boolean=True); virtual; stdcall; abstract;
    procedure Select_From_Series_Type_Name(const AWhat: array of string; const AWhere: array of string; var AResult: TStrings; const AClear_Result: Boolean=True); virtual; stdcall; abstract;
    procedure Select_From_Series_Type_Order(const AWhat: array of Integer; const AWhere: array of string; var AResult: TStrings; const AClear_Result: Boolean=True); virtual; stdcall; abstract;
    procedure Select_From_Series(const AWhat: array of Integer; const AWhere: array of string; var AResult: TStrings; const AClear_Result: Boolean=True); virtual; stdcall; abstract;
  ...
  ///<param name="ATD">Data type.</param>
  ///<param name="AHandle_Associativity">False if true, in case of an inverse link, the object created is a TD_Data_Link_Ass.</param>
  ///<param name="AID_Data">If not null, the data is read from the database.</param>
  TCreate_Data_From_TD=function(const ATD: Integer; const AHandle_Associativity: Boolean=False; const AID_Data: Integer=0): TD_Data; stdcall;
  ...
  ///<param name="AID_Data_Table">The identifier of the table data.</param>
  ///<param name="ADisplay">If true, the file exportated is opened. In case of an Excel file, </param>
  ///<returns>If the table Type's grapher is set to Excel, the function return the Excel OLE_Variant. In the other case, it returns the path to the text file written.</returns>
  TExport_Data_Table_To_File=function(const AID_Data_Table: Integer; const ADisplay: Boolean=False): Variant; stdcall;
  ...
  {$REGION 'U_Translation'}
  ///<summary>Class handling a translation.</summary>
  TT_Translation=class(TTree_Object)
  public
    ///<summary>Setter for the variable "sOriginal_Text".</summary>
    ///<summary>The original text of the translation.</summary>
    procedure Set_Original_Text(const AOriginal: string); virtual; stdcall; abstract;
    ///<summary>Getter for the variable "sOriginal_Text".</summary>
    ///<summary>The original text of the translation.</summary>
    function Get_Original_Text: string; virtual; stdcall; abstract;
    ///<summary>Setter for the variable "sTranslation".</summary>
    ///<summary>The translated text.</summary>
    procedure Set_Translation(const ATranslation: string); virtual; stdcall; abstract;
    ///<summary>Getter for the variable "sTranslation".</summary>
    ///<summary>The translated text.</summary>
    function Get_Translation: string; virtual; stdcall; abstract;
    ///<summary>Setter for the variable "ID_Language".</summary>
    ///<summary>The identifier of the language.</summary>
    procedure Set_ID_Language(const AID_Language: Integer); virtual; stdcall; abstract;
    ///<summary>Getter for the variable "ID_Language".</summary>
    ///<summary>The identifier of the language.</summary>
    function Get_ID_Language: Integer; virtual; stdcall; abstract;
  end;

  ///<summary>Function returning the Translation object.</summary>
  TCreate_Translation=function: TT_Translation; stdcall;
  {$ENDREGION}

  {$REGION 'U_Translation_Object_Type'}
  ///<summary>Class handling the translation of an Object Type name or description.</summary>
  TT_Translation_Object_Type=class(TOTObject)
  public
    ///<summary>Setter for the variable "bTranslate_Attributes".</summary>
    ///<summary>If true, translate the attributes.</summary>
    procedure Set_Translate_Attributes(const ATranslate_Attributes: Boolean); virtual; stdcall; abstract;
    ///<summary>Getter for the variable "bTranslate_Attributes".</summary>
    ///<summary>If true, translate the attributes.</summary>
    function Get_Translate_Attributes: Boolean; virtual; stdcall; abstract;
    ///<summary>Setter for the variable "bTranslate_Objects".</summary>
    ///<summary>If true, translate the objects.</summary>
    procedure Set_Translate_Objects(const ATranslate_Objects: Boolean); virtual; stdcall; abstract;
    ///<summary>Getter for the variable "bTranslate_Objects".</summary>
    ///<summary>If true, translate the objects.</summary>
    function Get_Translate_Objects: Boolean; virtual; stdcall; abstract;
    ///<summary>Setter for the variable "ID_Language".</summary>
    ///<summary>The identifier of the language.</summary>
    procedure Set_ID_Language(const AID_Language: Integer); virtual; stdcall; abstract;
    ///<summary>Getter for the variable "ID_Language".</summary>
  ...
  TCreate_Translation_Object_Type=function: TT_Translation_Object_Type; stdcall;
  {$ENDREGION}
  ...
  public
    ...
    function Get_Child_Result(const AID_Criterion_Preselection: Integer): TMCS_Results; virtual; stdcall; abstract;
  ...
  public
    ///<summary>Getter for the variable "OL_Translation_Object_Type".</summary>
    ///<summary>List of Object Types translations.</summary>
    function Get_OL_Translation_Object_Type: TObjectList; virtual; stdcall; abstract;
    ///<summary>Getter for the variable "OL_Translation".</summary>
    ///<summary>List of TT_Translation.</summary>
    function Get_OL_Translation: TObjectList; virtual; stdcall; abstract;
    ...
    ///<summary>Setter for the variable "bTranslate_Attribute_Sets".</summary>
    ///<summary>If true, Attributes Sets must be translated.</summary>
    procedure Set_Translate_Attribute_Sets(const ATranslate_Attribute_Sets: Boolean); virtual; stdcall; abstract;
    ///<summary>Getter for the variable "bTranslate_Attribute_Sets".</summary>
    ///<summary>If true, Attributes Sets must be translated.</summary>
    function Get_Translate_Attribute_Sets: Boolean; virtual; stdcall; abstract;
    ///<summary>Setter for the variable "bTranslate_Choice_Guides".</summary>
    ///<summary>If true, Choice Guides must be translated.</summary>
    procedure Set_Translate_Choice_Guides(const ATranslate_Choice_Guides: Boolean); virtual; stdcall; abstract;
    ///<summary>Getter for the variable "bTranslate_Choice_Guides".</summary>
    ///<summary>If true, Choice Guides must be translated.</summary>
    function Get_Translate_Choice_Guides: Boolean; virtual; stdcall; abstract;
    ///<summary>Setter for the variable "bTranslate_Units".</summary>
    ///<summary>If true, Units must be translated.</summary>
    procedure Set_Translate_Units(const ATranslate_Units: Boolean); virtual; stdcall; abstract;
    ///<summary>Getter for the variable "bTranslate_Units".</summary>
    ///<summary>If true, Units must be translated.</summary>
    function Get_Translate_Units: Boolean; virtual; stdcall; abstract;
    procedure Set_Translate_Tables_Types(const ATranslate_Tables: Boolean); virtual; stdcall; abstract;
    function Get_Translate_Tables_Types: Boolean; virtual; stdcall; abstract;
    ///<summary>Setter for the variable "bTranslate_BusinessViews".</summary>
    ///<summary>If true, Business views must be translated (name, file path).</summary>
    procedure Set_Translate_BusinessViews(const ATranslate_BusinessViews: Boolean); virtual; stdcall; abstract;
    ///<summary>Getter for the variable "bTranslate_BusinessViews".</summary>
    ///<summary>If true, Business views must be translated (name, file path).</summary>
    function Get_Translate_BusinessViews: Boolean; virtual; stdcall; abstract;
    ///<summary>Setter for the variable "bTranslate_Exportations".</summary>
    ///<summary>If true, Exportations must be translated (name, file path).</summary>
    procedure Set_Translate_Exportations(const ATranslate_Exportations: Boolean); virtual; stdcall; abstract;
    ///<summary>Getter for the variable "bTranslate_Exportations".</summary>
    ///<summary>If true, Exportations must be translated (name, file path).</summary>
    function Get_Translate_Exportations: Boolean; virtual; stdcall; abstract;
    ///<summary>Setter for the variable "bTranslate_Model_Applications".</summary>
    ///<summary>If true, Models Applications must be translated.</summary>
    procedure Set_Translate_Model_Applications(const ATranslate_Model_Applications: Boolean); virtual; stdcall; abstract;
    ///<summary>Getter for the variable "bTranslate_Model_Applications".</summary>
    ///<summary>If true, Models Applications must be translated.</summary>
    function Get_Translate_Model_Applications: Boolean; virtual; stdcall; abstract;
    ///<summary>Function returning the TT_Translation associated to the given original text.</summary>
    ///<param name="AText">The text of the translation.</param>
    function Get_Translation(const AText: string): TT_Translation; virtual; stdcall; abstract;
    ///<summary>Function returning the TT_Object_Type_Translation associated to the given Object Type.</summary>
    ///<param name="AID_OT">The identifier of the Object Type.</param>
    function Get_Translation_Object_Type(const AID_OT: Integer): TT_Translation_Object_Type; virtual; stdcall; abstract;
    ///<summary>Procedure removing an Object_Type_Translation.</summary>
    ///<param name="AID_OT">The identifier of the Object_Type_Translation to remove.</param>
    procedure Remove_Translation_Object_Type(const AID_OT: Integer); virtual; stdcall; abstract;
    ///<summary>Procedure importing the translations of the given po file.</summary>
    ///<param name="APath_file">The path of the po file.</param>
    procedure Import(const APath_file: string); virtual; stdcall; abstract;
    ///<summary>Procedure purging the translation. Removing unused translations.</summary>
    ///<param name="APath_File">The path of the po file.</param>
    procedure ResetAndImport(const APath_File: string); virtual; stdcall; abstract;
    ///<summary>Procedure generating a translation template file.</summary>
    function ToPOFile(const APath_File: string): string; virtual; stdcall; abstract;
    ...
    ///<param name="ATD">The Data Type.</param>
    ///<param name="AText">The text to translate.</param>
    ///<param name="AID_OT">The identifier Object Type in case of translation depending on more complex settings.</param>
    function Translate(const ATD: Integer; const AText: string; const AID_OT: Integer=0): string; virtual; stdcall; abstract;
    ///<summary>Function checking if a given concept is translatable.</summary>
    ///<param name="ATD">The TD of the Object.</param>
    ///<param name="AID_OT">The identifier Object Type in case of translation depending on more complex settings.</param>
    function IsTranslatable(const ATD: Integer; const AID_OT: Integer=0): Boolean; virtual; stdcall; abstract;
    function Update_Translation(const ATD: Integer; const ALeft: string; const ARight: string; const AID_OT: Integer=0): Boolean; virtual; stdcall; abstract;
  end;

  ///<summary>Function returning the Language object.</summary>
  ...
  public
    ...
    procedure Add_To_Attributes(AOlAttribute: TObjectList; AArr_TD: array of Integer; AIgnore_Inherited_Attributes: Boolean=False; AReadSources: Boolean=False); overload; virtual; stdcall; abstract;
  ...
  TCreate_Object=function(const AIdObject: Integer=0; const ADataType: Integer=-3): TS_Object; stdcall;
  {$ENDREGION}
  ...
  public
    ...
    function SearchBusinessObject_(const AIdBusinessView: Integer; const AIdObject: Integer): TObjectList; virtual; stdcall; abstract;
  ...
  public
    ...
    function Contextualize(const S: string; const AObject: TS_Object_Data; const ADataSeparator: string=','): string; overload; virtual; stdcall; abstract;
  ...
  public
    function LoadTxDll(const AFilePath: string; const AKeepLoaded: Boolean; out AUnload: Boolean): NativeUInt; virtual; stdcall; abstract;
...
var
  ...
  {$REGION 'U_Translation'}
  Create_Translation: TCreate_Translation;
  {$ENDREGION}
...
begin
  ...
  {$REGION 'U_Translation'}
  @Create_Translation := Get_Dll_Function_Adress(hDll,'Create_Translation',AFilePath);
  {$ENDREGION}
