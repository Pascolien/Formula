...
//
  ...
  C_Key_ID_Data_Table_To_Save = 'ID_Data_Table2Save';
  C_Key_ID_BV='ID_BV';
  C_Key_ID_CG='ID_CG';
  C_Key_ID_ACS = 'ID_ACS';
  ...
  {$REGION 'WEB'}
  C_Tag_Browse_URL_Win  = 'navigation.aspx?';
  C_Tag_Browse_URL_WEB = 'navigation.aspx?sender=form&';
  ...
  C_Tag_Browse_URL_Navigation = 'navigation.aspx';
  C_Web_Ok = 'ok';
  C_Web_Ko = 'ko';
  C_Web_Null = '<null>';
  {$ENDREGION}
