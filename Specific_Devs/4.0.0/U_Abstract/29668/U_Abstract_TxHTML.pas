...
type
  ...
  {$REGION 'U_Statistics'}
  TStatisticsToHTMLFile=function(AIdAttribute: Integer; APictureFilePath: string; AText: string): string; stdcall;

  TCorrelationToHTMLFile=function(APictureFilePath: string; AText: string): string; stdcall;
  {$ENDREGION}
