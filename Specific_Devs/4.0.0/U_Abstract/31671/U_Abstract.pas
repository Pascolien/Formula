...
type
  ...
  TMove_Object=procedure(const AIdObject: Integer; const AIdObjectType: Integer; const AIdPrevParent: Integer; const AIdNewParent: Integer; const AIdNewNextSibling: Integer; const AMode: TObjectKinship; const ATrashMode: TTrash_Mode=tmNone; const ATriggerModelApplications: Boolean=True); stdcall;
  ...
  public
    ...
    function OwnsObject(const AIdObject: Integer): Boolean; virtual; stdcall; abstract;
  ...
  ///<param name="ARemainingDuration">The remainning duration in seconds of object locking.</param>
  TCheckIf_Object_Locked=function(const AID_Object: Integer; out AUserIsLocker: Boolean; out AMessage: string; out ARemainingDuration: string): Boolean; stdcall;
  ...
  public
    procedure Set_ID_Object(const AIdObject: Integer; const AForceRefresh: Boolean=False); virtual; stdcall; abstract;
    procedure Uninitialize; virtual; stdcall; abstract;
    function IsRootAttribute(const AIdAttribute: Integer): Boolean; virtual; stdcall; abstract;
    function Get_ID_Attribute: Integer; virtual; stdcall; abstract;
    function Set_Root_Objects(const AIdRootAttribute: Integer; const ASlIdRootObject: TStringList): Boolean; overload; virtual; stdcall; abstract;
    function Set_Root_Objects(const AIdRootAttribute: Integer; const AIdsRootObjects: string): Boolean; overload; virtual; stdcall; abstract;
    function Create_OL_Leaf_Object(out AFullObjectType: Boolean): TObjectList; virtual; stdcall; abstract;
  end;
  {$ENDREGION}

  {$REGION 'U_Attribute_Filters_Manager'}
  TGet_Attribute_Filter=function(const AIdAttribute: Integer): TAttribute_Filter; stdcall;
  {$ENDREGION}
