...
type
  ...
  TImportTable=function(AArr_Input: array of TVarRec): TArr_VarRec; stdcall;
  {$ENDREGION}
  ...
  {$REGION 'U_ExcelFile'}
  TLoadExcelFile=function(AArrParameter: array of TVarRec): TArr_VarRec; stdcall;
  {$ENDREGION}
...
begin
  ...
  @ImportTable := Get_Dll_Function_Adress(hDll,'ImportTable',AFilePath);
  {$ENDREGION}
  ...
  {$REGION 'U_ExcelFile'}
  @LoadExcelFile := Get_Dll_Function_Adress(hDll,'LoadExcelFile',AFilePath);
  {$ENDREGION}
