...
(function (factory) {
	...
	*/
    var Timepicker = function () {
        ...
        this.regional[''] = { // fr regional settings
            currentText: _('Maintenant'),
            closeText: _('Valider'),
            amNames: ['AM', 'A'],
            pmNames: ['PM', 'P'],
            timeFormat: 'HH:mm',
            timeSuffix: '',
            timeOnlyTitle: _('Choisir un temps'),
            timeText: _('Temps'),
            hourText: _('Heure'),
            minuteText: _('Minute'),
            secondText: _('Seconde'),
            millisecText: _('Milliseconde'),
            microsecText: _('Microseconde'),
