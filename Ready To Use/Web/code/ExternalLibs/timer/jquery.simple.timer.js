...
(function($){
  ...
  var Timer = function (targetElement, options) {
  ...
  Timer.start = function(options, targetElement){
      timer = new Timer(targetElement, options);
    return timer.start(options);
  };

  Timer.prototype.start = function (options, createDiv) {
      createDiv = createDiv ? createDiv : true;
